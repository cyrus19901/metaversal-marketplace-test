...
const Modal: React.FC<ModalProps> = ({ name, onClose, image, price, receiveAddress, feeRate, fileName, devFee }) => {
        ...
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="button-container">
                    ...
                    <Button type="primary" style={{ width: "100%" }} className="mint-button" onClick={createOrder}>Mint</Button>
                </div>
            </div>
